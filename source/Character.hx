...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			case 'gf':
				// GIRLFRIEND CODE
				tex = Paths.getSparrowAtlas('gf_no');
				frames = tex;
			...
			case 'parents-christmas':
				...
				playAnim('idle');
			case 'hank':
					var tex = Paths.getSparrowAtlas('hank_and_tricky_shit/PlayableHank','shared');
					frames = tex;
					animation.addByPrefix('idle', 'BF idle dance', 24, false);
					animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
					...
					flipX = true;
				case 'tiky':
						frames = Paths.getSparrowAtlas('hank_and_tricky_shit/trickystuff/EXTRICKY');
						...
						animation.addByPrefix('singUP-alt', 'Hank', 24, false);
						addOffset('idle');
						addOffset("singUP", -9, 122);
						addOffset("singRIGHT", -345, -16);
						addOffset("singLEFT", 199, 121);
						addOffset("singDOWN", -124, -274);
						addOffset("singUP-alt", -9, 122);
